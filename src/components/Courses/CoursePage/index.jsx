    ...
    <div className="container">
      <div className={styles.page}>
        ...
        <div className={styles.ask}>
          <div className={styles.ask__box}>
            <svg onClick={() => setAsk(!ask)} version="1.1" viewBox="0 0 24 24"><g id="Layer_1" /><g id="Layer_2"><g><path d="M12,2C6.5,2,2,6.5,2,12s4.5,10,10,10s10-4.5,10-10S17.5,2,12,2z M12,20c-4.4,0-8-3.6-8-8s3.6-8,8-8s8,3.6,8,8    S16.4,20,12,20z" /><path d="M12.1,7.3h-0.1c-1,0-1.9,0.5-2.4,1.3C9.2,9.1,9.3,9.7,9.8,10c0.5,0.3,1.1,0.2,1.4-0.3c0.2-0.3,0.5-0.4,0.8-0.4h0.1    c0.5,0,0.9,0.4,0.9,0.9c0,0.4-0.3,0.8-0.6,0.9l-0.7,0.2c-0.4,0.1-0.7,0.5-0.7,0.9V13c0,0.6,0.4,1,1,1c0.5,0,1-0.4,1-0.9    c1.2-0.4,2-1.5,2-2.8C15,8.7,13.7,7.3,12.1,7.3z" /><circle cx="12" cy="16" r="1" /></g></g></svg>
            {ask &&
              <div className={styles.ask__open}>
                <span>Ask question</span>
                <textarea></textarea>
                <button className="blue-btn" onClick={() => setAsk(!ask)}>Ask</button>
              </div>
            }
          </div>
        </div>
                ...
                {e.items.map((m, j) => {
                  return (
                    <div className={styles.module__item} key={`${id}-${j}`}>
                      ...
                      {(m.type == 'lesson' || m.type == 'resource') ?
                        <Link href={`/course/lesson/${m.id || j + 1}`}>{m.title}</Link>
                        :
